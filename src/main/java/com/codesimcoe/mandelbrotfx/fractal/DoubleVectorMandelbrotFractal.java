...
public enum DoubleVectorMandelbrotFractal implements Fractal {
  DOUBLE_VECTOR_MANDELBROT;
  ...
  public ValueComplex computeIteration(ValueComplex z, ValueComplex zPrev, ValueComplex c) {
    throw new UnsupportedOperationException("VectorMandelbrotFractal shall uses dedicated Vector-API computation");
  }

  @Override
  public String getName() {
    return "DoubleVector Mandelbrot";
  }
}
